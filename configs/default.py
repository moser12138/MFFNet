...
_C.MODEL = CN()
_C.MODEL.NAME = 'ownmodel'
_C.MODEL.PRETRAINED = 'pretrained_models/MFFNet_CamVid_78_56.pt'
...
_C.DATASET.TRAIN_SET = 'list/camvid/trainval.lst'
_C.DATASET.EXTRA_TRAIN_SET = ''
_C.DATASET.TEST_SET = 'list/camvid/test.lst'
