...
cfg_file=configs/bisenetv2_city.py
NGPUS=1
torchrun --nproc_per_node=$NGPUS tools/train_amp_try2.py --config $cfg_file
...
cfg_file=configs/bisenetv2_city.py
NGPUS=1
torchrun --nproc_per_node=$NGPUS tools/train_amp_try3.py --config $cfg_file
...
cfg_file=configs/bisenetv2_city.py
NGPUS=1
torchrun --nproc_per_node=$NGPUS tools/train_amp_try4.py --config $cfg_file

export TORCH_DISTRIBUTED_DEBUG=DETAIL
export CUDA_VISIBLE_DEVICES=0
cfg_file=configs/bisenetv2_camvid.py
NGPUS=1
torchrun --nproc_per_node=$NGPUS tools/train_amp_try4.py --config $cfg_file
...
cfg_file=configs/bisenetv2_city.py
NGPUS=1
torchrun --nproc_per_node=$NGPUS tools/train_amp_ddrnet.py --config $cfg_file
...
cfg_file=configs/bisenetv2_city.py
NGPUS=1
torchrun tools/speed_evaluate.py --config $cfg_file
